...
#Login into the website, scrape data and save to text file
def getData():
...
#Check if phone server is online
def checkData():
...
#Send email message depending whether 
